...
<body>
    ...
    <div class="container px-4">
        <div class="bg-success p-4 mt-3">
            <h1 class="display-4 text-light">Cadastro das Receitas</h1>
        </div>
        ...
        <form class="dados" id="dados" method="post" action="ReceitaServlet">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4  my-3">
                    ...
                    <input type="date" class="form-control" id="dataCadastro" name="dataCadastro" pattern="\d{2}/\d{2}/\d{4}" >
                     <!-- pattern="\d{2}/\d{2}/\d{4}" -->
                </div>

               <div class="col-md-4  my-3">
                  <!--   <label for="descricao" class="form-label">Descrição</label>
                    <input type="date" class="form-control" id="categoria" name="categoria"> -->
            ...
            <div class="d-flex justify-content-end mt-3">
              ...
              <a href="menuUsuario.jsp" class="btn btn-primary">Menu</a>
